...
Console.WriteLine("Thông tin danh muc");
...
c2.AddProduct(new Product() {Id =6,Name="Tiger", Quantity = 15, Price = 33 });
c2.AddProduct(new Product() { Id = 7, Name = "HUda", Quantity = 20, Price = 25 });
c2.AddProduct(new Product() { Id = 8, Name = "Ken", Quantity = 15, Price = 50 });
categories.AddFirst(c2);
Console.WriteLine("Danh sách các theo  danh mục");
